...
(defun dotspacemacs/user-config ()
  ...
  (custom-set-faces
   '(diff-hl-insert ((t (:background "#7E8E50"))))
   '(diff-hl-change ((t (:background "#4B6B88"))))
